...
export function ExpenseForms({
  ...
  onSubmitIncome,
  onSubmitExpense,
  prioritizeExpense = false,
}: ExpenseFormsProps) {
  const incomeFormNode = (
  ...
  return (
    <section className="content-grid">
      {prioritizeExpense ? expenseFormNode : incomeFormNode}
      {prioritizeExpense ? incomeFormNode : expenseFormNode}
    </section>
  );
}
